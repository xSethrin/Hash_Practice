...
public class HashChain<K, V >{
	...
	**/
	public HashChain(int size){
		...
		//initialize hashTable with empty lined list
	...
	*/
	public void rehash(){
		...
		//initialize SLLIsts so they are not null
	...
	*/
	public HashNode<K,V> search(K key, V value){
		...
		SLList<HashNode<K,V>> l = hashTable[position];
		//System.out.println(value + " should be at possition " + position);
		Node<HashNode<K,V>> n = l.getHead();
		int itemNumber = 0;
		while(n != null) {
			if(n.getElement().getValue().equals(value)) {
				//System.out.println("The number of places in list searched before finding the value of " + value + " is " + itemNumber);
				//System.out.println();
				return n.getElement();
			}
			n = n.getNext();
		...
		//System.out.println("The number of places in list searched before not finding the value of " + value + " is " + itemNumber);
		//System.out.println();
		return null;
	}
	...
	public void remove(K key, V value){
		int position = hashCode(key, hashTable.length);
		SLList<HashNode<K,V>> l = hashTable[position];
		//System.out.println("Removing " + value + " should be at possition " + position);
		Node<HashNode<K,V>> n = l.getHead();
		int itemNumber = 0;
		while(n != null) {
			if(n.getElement().getValue().equals(value)) {
		...
		//System.out.println(value + " is not in the table and cannot be removed!");
		//System.out.println();
	}
